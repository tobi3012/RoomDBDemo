...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rcListUser = findViewById(R.id.rvListUser);
        ...
        rcListUser.setLayoutManager(new LinearLayoutManager(this));
        rcListUser.setAdapter(userAdapter);
    }
